                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="w-100 text-end">
                                            <span class="fs-12 text-dark"><span
                                                    class="counter">{{ $activeInterns }}</span>/<span
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark">
                                                <span class="counter">{{ $mentorCount }}</span>
                                            </div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">
                                                Total Mentor
                                            </h3>
                                ...
                                <div class="pt-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="w-100 text-end">
                                            <span class="fs-12 text-dark"><span
                                                    class="counter">{{ $activementors }}</span>/<span
                                                    class="counter">{{ $mentorCount }}</span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="w-100 text-end">
                                            <span class="fs-12 text-dark"><span
                                                    class="counter">{{ $completedCount }}</span>/<span
