                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-white border-bottom">
                                <h4 class="mb-0 fw-semibold">
                                    <i class="feather feather-clipboard me-2 text-primary"></i>
                                    Project Assignment
                                </h4>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="project_name" class="form-control"
                                                    placeholder="Enter project name" value = "{{ $project->project }}">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" id="submit_date" name="submit_date"
                                                    class="form-control"
