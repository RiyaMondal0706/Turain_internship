                                                            ...
                                                            <tr class="shadow-sm rounded mb-2">
                                                                ...
                                                                <td>
                                                                    @forelse ($assignment as $item)
                                                                        <span
                                                                            class="badge rounded-pill bg-primary mb-1 px-3 py-2">{{ $item->project }}</span><br>
                                                                    @empty
                                                                ...
                                                                <td>
                                                                    @forelse ($assignment as $item)
                                                                        <span
                                                                            class="text-secondary">{{ \Carbon\Carbon::parse($item->start_date)->timezone('Asia/Kolkata')->format('d M Y') }}</span><br>
                                                                    @empty
                                                                ...
                                                                <td>
                                                                    @forelse ($assignment as $item)
                                                                        <span
                                                                            class="text-secondary">{{ \Carbon\Carbon::parse($item->end_date)->timezone('Asia/Kolkata')->format('d M Y') }}</span><br>
                                                                    @empty
                                                                        <span class="text-muted">N/A</span>
                                                                    @endforelse
                                                                </td>
