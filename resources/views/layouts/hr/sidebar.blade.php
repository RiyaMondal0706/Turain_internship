              ...
              <ul class="nxl-navbar">
                  ...
                  <li class="nxl-item">
                      <a class="nxl-link" href="{{ route('hr.mentor.list') }}">
                          ...
                          <span class="nxl-text">Mentor List</span>
                      </a>
                  </li>


                  <li class="nxl-item">
                      <a class="nxl-link" href="{{ route('hr.assign.list') }}">
                          <span class="nxl-micon">
                              <i class="feather feather-user-plus"></i>
                          </span>
                          <span class="nxl-text">Assign Student</span>
                      </a>
                  </li>
                  ...
                  {{-- <li class="nxl-item nxl-hasmenu">
                      <a href="javascript:void(0);" class="nxl-link">
                          ...
                          <span class="nxl-mtext">Mentor </span><span class="nxl-arrow"><i
                                  class="feather-chevron-right"></i></span>
                      </a>
                      <ul class="nxl-submenu">
                          <li class="nxl-item"><a class="nxl-link" href="{{ route('hr.mentor.list') }}">Mentor
                                  List</a></li>

                          <li class="nxl-item"><a class="nxl-link" href="{{ route('hr.mentor.create') }}">Mentor
                                  Create</a></li>
                      </ul>
                  </li> --}}
                  {{-- <li class="nxl-item nxl-hasmenu">
                      <a href="javascript:void(0);" class="nxl-link">
                          <span class="nxl-micon"><i class="feather-users"></i></span>
                          <span class="nxl-mtext">Assign </span><span class="nxl-arrow"><i
                                  class="feather-chevron-right"></i></span>
                      </a>
                      <ul class="nxl-submenu">
                          <li class="nxl-item"><a class="nxl-link" href="{{ route('hr.assign.create') }}">Assign
                                  Student</a></li>

                          <li class="nxl-item"><a class="nxl-link" href="{{ route('hr.assign.list') }}">Assign
                                  List</a></li>
                      </ul>
                  </li> --}}
