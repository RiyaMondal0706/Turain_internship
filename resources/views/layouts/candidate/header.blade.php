        ...
        <div class="header-right ms-auto">
            <div class="d-flex align-items-center">
                ...
                @php
                    ...
                    $intern = DB::table('users')->where('id', $userId)->first();
                    $internimage = DB::table('intern_data')->where('id', $intern->internship_data_id)->first();
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button"
                        data-bs-auto-close="outside">
                        <img src="{{ asset('/assets/images/intern/' . $internimage->image) }}" alt="user-image"
                            class="img-fluid user-avtar me-0" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('/assets/images/intern/' . $internimage->image) }}"
                                    alt="user-image" class="img-fluid user-avtar" />
                                <div>
                                    <h6 class="text-dark mb-0">{{ $internimage->name }} <span
                                            class="badge bg-soft-success text-success ms-1">Candidate</span></h6>
                                    <span class="fs-12 fw-medium text-muted">{{ $internimage->email }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('profile.idcard') }}" class="dropdown-item">
