                    ...
                    <div class="chat-container">
                            ...
                            <div class="user-list d-none" id="userList">
                                @foreach ($users as $user)
                                    <div class="user-item" data-id="{{ $user->id }}" data-name="{{ $user->name }}"
                                        data-role="{{ $user->role }}" data-avatar="{{ $user->images }}">
                                        {{ $user->name }}
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="chat-box">
                            <div class="chat-header" id="chatHeader">
                                <img id="chatHeaderImg" src="/assets/images/candidate/default.png" alt="">
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            document.getElementById('chatHeaderName').textContent =
                item.dataset.name || item.innerText.trim();

            // ===== ROLE & AVATAR (FROM CLICKED USER) =====
            let role = item.dataset.role || 'mentor';
            let avatar = item.dataset.avatar || '2.png';

            const imgPath = `/assets/images/${role}/${avatar}`;
            console.log('HEADER IMAGE:', imgPath);
            ...
            img.onerror = function() {
                this.src = `/assets/images/${role}/default.png`;
            };
