...
<head>
    ...
    <title>Turain || Department Create</title>
    ...
    <style>
        ...
        .custom-input-group:focus-within {
            box-shadow: 0 0 0 3px rgba(98, 89, 202, 0.15);
        }
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-header bg-white py-3">
                                    <h5 class="card-title mb-0 fw-bold text-dark">
                                        <i class="feather feather-plus-circle text-primary me-2"></i> Add New Department
                                    </h5>
                                </div>
                                <div class="card-body p-4">
                                    <form action="{{ route('hr.designation.store') }}" method="POST">
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="department_id" class="form-label fw-semibold text-muted mb-2">
                                                Department Name
                                            </label>

                                            <div class="input-group custom-input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                                    <i class="feather feather-layers text-muted"></i>
                                                </span>
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="designation_name"
                                                class="form-label fw-semibold text-muted mb-2">
                                                Designation Name
                                            </label>

                                            <div class="input-group custom-input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                                    <i class="feather feather-briefcase text-muted"></i>
                                                </span>
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="level" class="form-label fw-semibold text-muted mb-2">
                                                Level
                                            </label>

                                            <div class="input-group custom-input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                                    <i class="feather feather-trending-up text-muted"></i>
                                                </span>
                                        ...
                                        <div class="d-flex justify-content-end gap-2 border-top pt-4">
                                            ...
                                            <button type="submit" class="btn btn-primary px-4 shadow-sm">
                                                <i class="feather feather-check-circle me-1"></i> Save Designation
                                            </button>
                                        </div>
                                    </form>
