                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="designationInput"
                                                            ...
                                                            <option value="intern"
                                                                {{ $intern->designation == 'intern' ? 'selected' : '' }}>
                                                                Intern
                                                            </option>

                                                            <option value="junior_developer"
                                                                {{ $intern->designation == 'junior_developer' ? 'selected' : '' }}>
                                                                Junior Developer
                                                            </option>

                                                            <option value="senior_developer"
                                                                {{ $intern->designation == 'senior_developer' ? 'selected' : '' }}>
                                                                Senior Developer
                                                            </option>

                                                            <option value="designer"
                                                                {{ $intern->designation == 'designer' ? 'selected' : '' }}>
                                                                Designer
                                                            </option>

                                                            <option value="tester"
                                                                {{ $intern->designation == 'tester' ? 'selected' : '' }}>
                                                                Tester
                                                            </option>
                                                        </select>
