...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card border-top-0">
                            ...
                            <form id="mentorForm" action="{{ route('assign.store') }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-4">
                                        <button type="submit" class="btn btn-primary px-4" id="submitBtn">
                                            <span class="btn-text">Assign Mentor </span>
                                            <span id="submitLoader" class="spinner-border spinner-border-sm d-none ms-2"
    ...
    <script>
        ...
        mentorForm.addEventListener('submit', function(e) {
            ...
            mentorForm.querySelectorAll('.form-select').forEach(select => {
            ...
            if (!internSelect.value) {
                internSelect.classList.add('is-invalid');
                valid = false;
            }
