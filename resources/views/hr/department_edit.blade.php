...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.mobiscroll.com/5.8.3/css/mobiscroll.min.css">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Department Edit</li>
                    </ul>
                </div>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-header bg-white py-3">
                                    <h5 class="card-title mb-0 fw-bold text-dark">
                                        <i class="feather feather-plus-circle text-primary me-2"></i> Edit Department
                                    </h5>
                                </div>
                                <form method="POST" action="{{ route('department.update', $department->id) }}">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="container">
                                            ...
                                            <h4 class="mb-4 fw-semibold text-dark">Edit Department</h4>
                                            ...
                                            <div class="mb-4">
                                                <label class="form-label fw-medium">Designations</label>
                                                <select id="designation_select" class="form-select">
